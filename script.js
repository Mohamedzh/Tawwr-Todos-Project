...
listarray = [];}else{
    ...
    while (i < listarray.length){
            ...
            list.innerHTML += `<div class="entry"><li class="entryli" class="list-group-item active">${listarray[i]}
...
var newTa = `<div class="entry"><li class="entryli" class="list-group-item active">${newtask}
<button type="button" id = "check"><i class="fa-solid fa-square-check"></i></button>
<button type = "button" id = "del"><i class="fa-solid fa-trash-can"></i></button>
</li></div>`;
...
function buttons(e){
    ...
    if (item.id === 'check'){
        //item.parentElement.innertex.strike();
